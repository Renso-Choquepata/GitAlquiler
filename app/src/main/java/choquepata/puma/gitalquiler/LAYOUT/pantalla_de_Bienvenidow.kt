...
class pantalla_de_Bienvenidow : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_pantalla_de_bienvenidow)
        Handler(Looper.getMainLooper()).postDelayed({
            val intentNextActivity = Intent(this, pantalla_de_elegirud::class.java)
